...
function Login({ setRoute }) {
  ...
  const [localRoute, setLocalRoute] = useState(ERoute.Login);
  const [passInputField, setPassInputField] = useState(
    <input
  ...
  const [passIcon, setPassIcon] = useState(
    <Lock onClick={(e) => onPasswordIcon(false)} className='passwordIcon' />
  );
  useEffect(() => {
  ...
  function changePassword(e) {
    if (isPasswordSelected === false) setIsPasswordSelected(true);
    ...
    return (
      <div className='login flex-y-center flex-column'>
        ...
        <div className='loginForm flex-y-center flex-column'>
          ...
          <div className='fields content-center-align'>
            <a className='forgetPassword'>Mot de passe oublié ?</a>
          </div>
          <div className='fields content-right-align'>
            <a className='notRegister'>
              Pas encore inscrit ?&nbsp;
              <div className='register' onClick={() => setRoute(ERoute.SignUp)}>
                Inscription
              </div>
            </a>
          </div>
  ...
  function getRenderer() {
    if (localRoute === ERoute.Login) return loginRenderer();
  ...
  return (
    <>
      <div className='mainContainer'>
        ...
        <div className='innerContainer'>{getRenderer()}</div>
      </div>
